...
<title>find/findId.jsp</title>
<style type="text/css">
.findId::-webkit-input-placeholder {
	text-align: center;
}
</style>
</head>
<body>
	...
	<hr width="700px">
	<form action="user.find.id.next" method="post"
		onsubmit="return findIdCheck();" name="findIdForm">
		<table style="margin: auto; margin-bottom:80px; width: 250px; height: 200px;">
			...
			<tr>
				...
				<td><input type="text" name="u_name" class="findId"
			...
			<tr>
				...
				<td><input type="text" name="u_email" class="findId"
